...
All external links have been manually tested, they all open up a new tab in the browser and work correctly by sending the user to a useful site. Lastly there are no major console errors, any which have occured have been 
dealt with within my code, such as errors with images not existing, in this situation I have provided an error image to give the user an indication it isnt working or doesnt exist whilst not displaying a broken image icon.
